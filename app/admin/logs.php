        ...
        <div class="main-container">
            ...
            <div class="row mb-4">
                <div class="col-md-3">
                    <div class="stat-card">
                        ...
                        <div class="stat-label"><i class="fas fa-calendar-day"></i> 今日日志</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-card">
                        <div class="stat-number"><?php echo number_format($stats['week']); ?></div>
                        <div class="stat-label"><i class="fas fa-calendar-week"></i> 本周日志</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-card">
                        <div class="stat-number"><?php echo number_format($stats['month']); ?></div>
                        <div class="stat-label"><i class="fas fa-calendar-alt"></i> 本月日志</div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="stat-card">
                        <div class="stat-number" style="color: #dc3545;"><?php echo number_format($stats['error']); ?></div>
                        <div class="stat-label"><i class="fas fa-exclamation-circle"></i> 错误记录</div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                    $typeInfo = $actionTypeLabels[$log['action_type']] ?? $actionTypeLabels['other'];
                                    ?>
                                    <span class="badge <?php echo $typeInfo['class']; ?> action-badge">
                                ...
                                <td>
                                    <?php if ($log['result'] == 1): ?>
                                        <span class="result-success"><i class="fas fa-check-circle"></i> 成功</span>
                                    <?php else: ?>
                                        <span class="result-fail"><i class="fas fa-times-circle"></i> 失败</span>
                                    <?php endif; ?>
                                </td>
            ...
            <nav class="mt-4">
                <ul class="pagination justify-content-center">
                    <?php if ($page > 1): ?>
                    <li class="page-item">
                        <a class="page-link" href="?page=<?php echo $page-1; ?>&action_type=<?php echo urlencode($actionType); ?>&search=<?php echo urlencode($search); ?>&date_from=<?php echo urlencode($dateFrom); ?>&date_to=<?php echo urlencode($dateTo); ?>">
                    ...
                    <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                        <a class="page-link" href="?page=<?php echo $i; ?>&action_type=<?php echo urlencode($actionType); ?>&search=<?php echo urlencode($search); ?>&date_from=<?php echo urlencode($dateFrom); ?>&date_to=<?php echo urlencode($dateTo); ?>">
                            <?php echo $i; ?>
                        </a>
                    </li>
                    <?php endfor; ?>
